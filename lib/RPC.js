...
RPC.prototype.call = function ( methodSignature , args , needReply ) {
	...
	var pubOpts = { correlationId : cid , replyTo : q , contentType : 'application/json' };
	var publish ; 
	
	if ( typeof needReply == 'undefined' || needReply ) {
