	...
	return self._connection.ready().then(function(conn){
		return self._channelPromise.then(function(ch){
			return self._queuePromise.then(function(q){
				return when({ queue : q , channel : ch , connection : conn })
			})
		})
	})
...
Queue.prototype.bind = function ( destExchange , routingKey , args ) {
...
Queue.prototype.unbind = function ( destExchange , routingKey , args ) {
...
Queue.prototype.consume = function () {
	...
	var opts = _.extend(options,{ consumerTag : uuid() });
