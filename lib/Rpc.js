...
Rpc.prototype.call = function ( q , args , options ) {
	
	var self = this ;
	var cid = uuid.v4(); // more unique b/ not timestamp based
	var routingKey ;
	if ( routingKey instanceof Queue ) {
		routingKey = q.name ;
